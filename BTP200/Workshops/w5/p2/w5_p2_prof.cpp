/***********************************************************************
// BTP200 Workshop #5 p2: tester program
//
// File	main_prof.cpp
// Version 1.0
// Author Mohammad Shamas
// Modified by cornel at some later date
// Description
//
// Revision History
// -----------------------------------------------------------
...
// Checking if header guards exist and follows convention.
	...
	#error "The header guard for 'ability.h' doesn't follow the convention!"
#endif

#ifndef SENECA_HERO_H
	#error "The header guard for 'hero.h' doesn't follow the convention!"
#endif
