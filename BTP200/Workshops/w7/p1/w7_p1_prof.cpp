...
// Checking if header guards exist and follows convention.
	...
	#error "The header guard for 'BankAccount.h' doesn't follow the convention!"
#endif
#ifndef SENECA_SAVINGSACCOUNT_H
	#error "The header guard for 'SavingsAccount.h' doesn't follow the convention!"
#endif
#ifndef SENECA_DEPOSITUTILITY_H
	#error "The header guard for 'DepositUtility.h' doesn't follow the convention!"
#endif
