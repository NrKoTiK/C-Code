...
namespace seneca
{
	...
	/* TD: add the prototype of the `loadData` function that receives as a parameter
	...
	*/
	...
	/* TD: add the prototype of the `display` function that receives as a parameter
	...
	*/
	...
	/* TD: add the prototype of the `display` function that receives as parameters
	...
	*/
	...
	/// </summary>
	/* TD: add the prototype of the `deallocateMemory` function.
	*         Implement it in the cpp file as described below.
	* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	*
	* deallocateMemory()
