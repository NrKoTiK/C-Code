...
#ifndef W2P1_DATAHANDLE_H
#define W2P1_DATAHANDLE_H
...
namespace seneca
{
	...
	/* TD: add the prototype of the `read` function that receives as a parameter
	...
	*/
	...
	/* TD: add the prototype of the `read` function that receives as parameters
